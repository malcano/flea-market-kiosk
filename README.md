...
## 🚀 라이브 데모 (Live Demo) 체험하기
설치 없이 지금 바로 웹에서 실제 앱의 작동을 테스트해 보실 수 있습니다.
👉 **[https://flea-market-kiosk.pages.dev/](https://flea-market-kiosk.pages.dev/)**
(아이패드 가로 모드나 브라우저의 모바일 환경 테스트 도구를 활용하시면 더욱 쾌적합니다.)
